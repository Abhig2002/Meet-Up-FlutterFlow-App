...
class ProfilePage4Widget extends StatefulWidget {
  const ProfilePage4Widget({Key? key}) : super(key: key);

  @override
  _ProfilePage4WidgetState createState() => _ProfilePage4WidgetState();
}

class _ProfilePage4WidgetState extends State<ProfilePage4Widget> {
  late ProfilePage4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilePage4Model());
  }
